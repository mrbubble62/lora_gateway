...
int lgw_start(void) {
    ...
    switch (brd_version) {
        case LGW_BRD_VERSION_1_0:
            lgw_i_tx_start_delay_us = 1495; /* adjusted to send Class-B beacons at 1500탎 after PPS +/-1탎 */
            break;
        case LGW_BRD_VERSION_1_5:
            lgw_i_tx_start_delay_us = 1494; /* adjusted to send Class-B beacons at 1500탎 after PPS +/-1탎 */
            break;
        default:
            /* nothing to do */
            break;
